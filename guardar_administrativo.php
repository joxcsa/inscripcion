...
<main class="formulario-contenedor">
  ...
  <form action="../Controlador/agregar_administrativo.php" method="post">
    <div class="campo">
      <label>Turno</label>
    ...
    <div class="campo">
      <label>RFC</label>
      <input type="text" name="rfc" maxlength="15" required>
    </div>
    <div class="campo">
      <label>Teléfono</label>
      <input type="tel" name="telefono" placeholder="000-000-0000" required>
    </div>
    <div class="campo">
      <label>Sexo</label>
    ...
    <div class="campo">
      ...
      <input type="number" name="experiencia" min="0" max="99" required>
    </div>
    <div class="campo">
      <label>Cuenta Bancaria</label>
      <input type="text" name="cuenta_banco" maxlength="20" required>
    </div>
    <div class="campo">
