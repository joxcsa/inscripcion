...
<head>
    ...
    <link rel="stylesheet" href="../Recursos/Diseño/estilo_forms.css"> <!-- Estilos neumórficos -->
</head>
<body>
...
<div class="formulario-contenedor">
    <h2 class="text-center">Formulario Grado</h2>

    <form action="../Controlador/agregar_grado.php" method="post">
        <div class="campo">
            <label>Grado</label>
            <input type="number" name="grado" min="1" max="9" required>
        </div>
