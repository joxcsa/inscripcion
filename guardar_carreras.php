...
<head>
    ...
    <link rel="stylesheet" href="../Recursos/Diseño/estilo_forms.css"> <!-- Asegúrate de enlazar tu archivo CSS personalizado -->
</head>
<body>
...
<div class="formulario-contenedor">
    <h2 class="text-center">Datos de la Carreras</h2>

    <form action="../Controlador/agregar_carrera.php" method="post">
        <div class="campo">
