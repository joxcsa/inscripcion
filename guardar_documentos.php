...
<head>
    ...
    <link rel="stylesheet" href="../Recursos/Diseño/estilo_forms.css"> <!-- Asegúrate de que este CSS tenga los estilos neumórficos -->
...
<div class="formulario-contenedor">
    <h2 class="text-center">Formulario Documentos</h2>
    
    <form action="../Controlador/agregar_documentos.php" method="post">
        <div class="mb-3">
        ...
        <div class="campo-checkbox">
            <input type="checkbox" name="acta_nacimiento" value="1">
            <label>Acta de Nacimiento</label>
        </div>
        <div class="campo-checkbox">
            <input type="checkbox" name="certificado_estudios" value="1">
        ...
        <div class="campo-checkbox">
            <input type="checkbox" name="seguro_social" value="1">
            <label>Seguro Social</label>
        </div>
        <div class="campo-checkbox">
            <input type="checkbox" name="comprobante_domicilio" value="1">
