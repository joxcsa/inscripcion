...
<main class="formulario-contenedor">
  ...
  <form action="../Controlador/agregar_aula.php" method="post">
    <div class="campo">
      <label>Número</label>
    ...
    <div class="campo">
      <label>Grupo</label>
      <input type="text" name="grupo" maxlength="10" required>
    </div>
    <div class="campo">
      <label>Grado</label>
      <input type="text" name="grado" maxlength="10" required>
    </div>
    <div class="campo">
      <label>Ubicación</label>
      <textarea name="ubicacion" rows="3" required></textarea>
    </div>
