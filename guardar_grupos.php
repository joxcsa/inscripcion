...
<head>
    ...
    <link rel="stylesheet" href="../Recursos/Diseño/estilo_forms.css"> <!-- Tu archivo neumórfico -->
</head>
<body>
...
<div class="formulario-contenedor">
    <h2 class="text-center">Formulario Grupo</h2>

    <form action="../Controlador/agregar_grupo.php" method="post">
        <div class="campo">
            <label>Grupo</label>
            <input type="text" name="grupo" maxlength="3" required>
        </div>
